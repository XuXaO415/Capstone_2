  ...
  static async register({
    ...
    const result = await db.query(
      `INSERT INTO users
            ...
            RETURNING username, first_name AS "firstName", last_name AS "lastName", email, phone, city, country, zipcode AS "zipCode", latitude, longitude, image_url AS "imageUrl", hobbies, interests`,
      [
        username,
        hashedPassword,
        firstName,
